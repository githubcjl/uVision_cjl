...
BEGIN_MESSAGE_MAP(CImageProcessDlg, CDialog)
	...
	ON_BN_CLICKED(IDC_HFLIP, &CImageProcessDlg::OnBnClickedHflip)
	ON_BN_CLICKED(IDC_VFLIP, &CImageProcessDlg::OnBnClickedVflip)
	ON_BN_CLICKED(IDC_MONO, &CImageProcessDlg::OnBnClickedMono)
	ON_BN_CLICKED(IDC_INVERSE, &CImageProcessDlg::OnBnClickedInverse)
	ON_BN_CLICKED(IDC_ONEWB2, &CImageProcessDlg::OnBnClickedOnewb2)
...
void CImageProcessDlg::OnShowWindow(BOOL bShow, UINT nStatus)
{
